            ...
            pw.Row(
              ...
              children: [
                ...
                if (POSPrinter.isLogoSet && POSPrinter.logo != null)
                  pw.Image(pw.MemoryImage(POSPrinter.logo!), width: 120, height: 120, fit: pw.BoxFit.contain)
                else
                ...
                pw.Expanded(
                  child: pw.Column(
                    ...
                    children: [
                      if (hasHeaderValue(POSPrinter.headerName)) pw.Text(POSPrinter.headerName!, style: titleStyle),
                      if (hasHeaderValue(POSPrinter.headerAddress)) pw.Text(POSPrinter.headerAddress!, textAlign: pw.TextAlign.right),
                      if (hasHeaderValue(POSPrinter.headerTaxID)) pw.Text('RUC: ${POSPrinter.headerTaxID}'),
                      if (hasHeaderValue(POSPrinter.headerDV)) pw.Text('DV: ${POSPrinter.headerDV}'),
                      if (hasHeaderValue(POSPrinter.headerPhone)) pw.Text('Tel: ${POSPrinter.headerPhone}'),
                      if (hasHeaderValue(POSPrinter.headerEmail)) pw.Text(POSPrinter.headerEmail!),
                      if (hasHeaderValue(POSPrinter.header1)) pw.Text(POSPrinter.header1!),
                      if (hasHeaderValue(POSPrinter.header2)) pw.Text(POSPrinter.header2!),
                      if (hasHeaderValue(POSPrinter.header3)) pw.Text(POSPrinter.header3!),
                      if (hasHeaderValue(POSPrinter.header4)) pw.Text(POSPrinter.header4!),
                    ],
                  ),
                ),
              ],
                ...
                pw.Expanded(
                  child: pw.Column(
                    ...
                    children: [
                      pw.Row(
                        children: [
                          pw.Text('Terminal: ', style: boldTextStyle),
                          pw.Text(terminal),
                        ],
                      ),
                      ...
                      pw.Row(
                        children: [
                          pw.Text('Cajero/Responsable: ', style: boldTextStyle),
                          pw.Text(rep),
                        ],
                      ),
                    ],
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      pw.Row(
                        ...
                        children: [
                          pw.Text('Desde Fecha: ', style: boldTextStyle),
                          pw.Text(dateFrom.isEmpty ? "---" : dateFrom),
                        ],
                      ),
                      pw.SizedBox(height: 4),
                      pw.Row(
                        mainAxisAlignment: pw.MainAxisAlignment.end,
                        children: [
                          pw.Text('Fecha de Cierre: ', style: boldTextStyle),
                          pw.Text(dateTrx.isEmpty ? "---" : dateTrx),
                        ],
                      ),
                    ],
                  ),
                          ...
                          pw.Padding(
                            ...
                            child: pw.Column(
                              children: [
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                  children: [pw.Text('Cantidad de Órdenes:'), pw.Text('$totalOrders')],
                                ),
                                pw.SizedBox(height: 4),
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                  children: [pw.Text('Base Impuesto:'), pw.Text(money(taxBase))],
                                ),
                                pw.SizedBox(height: 4),
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                  children: [pw.Text('Total Impuesto:'), pw.Text(money(taxAmt))],
                                ),
                                pw.SizedBox(height: 4),
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                  children: [pw.Text('Total Exento:'), pw.Text(money(exemptAmt))],
                                ),
                                pw.Divider(),
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                          ...
                          pw.Padding(
                            ...
                            child: pw.Column(
                              children: [
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                  children: [pw.Text('Cantidad de Devoluciones:'), pw.Text('$totalReturns')],
                                ),
                                pw.SizedBox(height: 4),
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                  children: [pw.Text('Base Imp. (Devolución):'), pw.Text(money(returnTaxBase))],
                                ),
                                pw.SizedBox(height: 4),
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                  children: [pw.Text('Impuesto (Devolución):'), pw.Text(money(returnTaxAmt))],
                                ),
                                pw.SizedBox(height: 4),
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                  children: [pw.Text('Exento (Devolución):'), pw.Text(money(returnExemptAmt))],
                                ),
                                pw.Divider(),
                                pw.Row(
                                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
